...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create WebPage-e159
  fly apps create WebPage-e159-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app WebPage-e159
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app WebPage-e159-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'WebPage-e159-staging' does not match app name in config file 'WebPage-e159'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name WebPage-e159-db
  fly postgres attach --app WebPage-e159 WebPage-e159-db

  fly postgres create --name WebPage-e159-staging-db
  fly postgres attach --app WebPage-e159-staging WebPage-e159-staging-db
  ```
