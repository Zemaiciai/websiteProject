...
export default function ProfileCard({
  ...
  return (
    <div className="profileCardDiv w-full h-full">
      <div className="relative">
        <img
          className="rounded-full absolute left-20 top-52 rounded-full outline-4 outline-white outline shadow-xl"
      ...
      <div className="backGroundPhoto w-full h-[285px] bg-gradient-to-r from-custom-800 to-zinc-600 shadow-xl overflow-auto"></div>
