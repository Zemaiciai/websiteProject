...
export const meta: MetaFunction = () => [{ title: "Prisijungti - Žemaičiai" }];
...
export default function LoginPage() {
  ...
  return (
    <main className="w-screen h-screen overflow-auto">
      <div className="w-screen h-screen absolute bg-white-background blur-[2px] bg-cover bg-center overflow-auto"></div>
