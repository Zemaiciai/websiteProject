...
export default function Join() {
  ...
  return (
    <div className="flex min-h-screen justify-center items-center bg-gradient-to-r from-cyan-500 to-blue-500">
      <div className="w-full px-4 sm:px-8 max-w-md bg-sky-500 border border-white rounded-lg">
        <div className="py-8">
