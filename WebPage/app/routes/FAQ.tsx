...
const FAQ = () => {
  ...
  return (
    <div style={{position: "relative", minHeight: "100vh"}}>
     ...
     {/* Navigation Sidebar */}
      <div style={{ float: "left", width: "10%", padding: "20px", backgroundColor: "#616161", borderRadius: "10px", position: "sticky", top: "0"}}>
        <nav>
          <p style={{color: "white", textAlign: "left", marginLeft: "20px", marginTop: "10px", fontWeight: "bold"}}>Navigation</p>
          {/* Your navigation links to question anchors go here */}
          <ul>
            {questions.map((item, index) => (
              <li key={index}>
                <a href={`#question${index + 1}`} onClick={() => toggleAnswer(index)} style={{ color: "white" }}>
                  {item.question}
                </a>
              </li>
            ))}
      ...
      <div style={{ marginLeft: "20%", padding: "20px" }}>
        ...
        <ul>
          {questions.map((item, index) => (
            <li key={index} id={`question${index + 1}`} style={{ marginBottom: "20px" }}>
              <button
...
<footer style={{ textAlign: "center", borderTop: "1px solid black", clear: "both", width: "100%", backgroundColor: "black", marginTop: "auto"}}>
